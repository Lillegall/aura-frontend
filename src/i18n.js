...
const it = {
  ...
  common: {
    ...
    offlineHint: 'Risposta di riserva generata sul dispositivo: l’AI al momento non è disponibile.',
  ...
  person: {
    ...
    ready: 'Pronto per una nuova analisi su {name}',
...
const en = {
  ...
  common: {
    ...
    offlineHint: 'Backup answer generated on your device: the AI isn’t available right now.',
